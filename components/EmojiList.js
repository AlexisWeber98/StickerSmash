...
export default EmojiList = ({ onSelect, onCloseModal }) => {
  const [emoji] = useState([
    ...
    require("../assets/images/emoji21.png"),
    require("../assets/images/emoji22.png"),
    require("../assets/images/emoji23.png"),
    require("../assets/images/emoji24.png"),
    require("../assets/images/emoji25.png"),
    require("../assets/images/emoji26.png"),
    require("../assets/images/emoji27.png"),
    require("../assets/images/emoji28.png"),
    require("../assets/images/emoji29.png"),
    require("../assets/images/emoji30.png"),
